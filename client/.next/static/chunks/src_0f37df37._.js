...
const buttonBase = "inline-flex items-center justify-center rounded-md px-3 py-1 text-sm font-medium transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer";
const buttonPrimary = `${buttonBase} bg-primary text-white hover:bg-primary/90 focus:ring-primary/70 cursor-pointer`;
const buttonSecondary = `${buttonBase} border border-primary hover:border-primary focus:ring-primary cursor-pointer`;
...
const SearchBar = ({ className })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchBar.useEffect": ()=>{
            ...
            const timeout = setTimeout({
                "SearchBar.useEffect.timeout": ()=>{
                    fetch(`/api/search?q=${query}`).then({
                        "SearchBar.useEffect.timeout": (res)=>res.json()
                    }["SearchBar.useEffect.timeout"]).then({
                        "SearchBar.useEffect.timeout": (data)=>setSuggestions(data.suggestions)
                    }["SearchBar.useEffect.timeout"]);
                }
            }["SearchBar.useEffect.timeout"], 300);
            return ({
                "SearchBar.useEffect": ()=>clearTimeout(timeout)
            })["SearchBar.useEffect"];
        }
    }["SearchBar.useEffect"], [
        query
    ...
    const handleKeyDown = (e)=>{
        ...
        switch(e.key){
            ...
            case "ArrowUp":
                e.preventDefault();
                setHighlightedIndex((prev)=>prev === 0 || prev === -1 ? suggestions.length - 1 : prev - 1);
                break;
            case "Enter":
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative w-full px-4 sm:px-6 lg:px-0 max-w-full sm:max-w-2xl mx-auto",
        children: [
            ...
            showDropdown && suggestions.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                className: "absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-md max-h-64 overflow-y-auto",
                children: suggestions.map((item, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        onClick: ()=>handleSelect(item),
                        className: `cursor-pointer px-4 py-2 text-primary ${i === highlightedIndex ? "bg-gray-100 font-semibold" : ""}`,
                        children: item
                    }, i, false, {
                        fileName: "[project]/src/components/SearchBar.tsx",
                        lineNumber: 95,
...
_s(SearchBar, "IQ+mStYtObYaHUFbXZjmcBxK47U=", false, function() {
    return [
...
const TestimonialItems = [
    {
        name: "Sophia Turner",
        position: "VP of Data Strategy",
        company: "BlueCore Inc.",
        logo: "/orgs/bluecore.jpeg",
        quote: "Hawket Data transformed how we approach real-time analytics. Their enterprise-grade pipelines helped us reduce processing time by 60%.",
        rating: 5
    },
    {
        name: "Liam Rodriguez",
        ...
        logo: "/orgs/nova.jpg",
        quote: "We rely on Hawket’s platform to unify our data sources securely and at scale. Their team understands what modern enterprises need.",
        rating: 5
    },
    {
        name: "Dr. Anika Bose",
        ...
        logo: "/orgs/vh.jpeg",
        quote: "From compliance to scalability, Hawket Data is unmatched. Our operational data is now a strategic advantage.",
        rating: 4
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
const Header = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: `fixed left-0 top-0 w-full z-10 transitions ${isSticky ? "bg-primary shadow-sm backdrop-blur-md text-white" : "bg-transparent text-primary"}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "root-container hidden lg:flex items-center justify-between h-16",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex-2 flex items-center gap-8",
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                                ...
                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navLinks"].map((link)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: link.href,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex-1 flex items-center gap-8 w-full whitespace-nowrap",
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: "/signup",
                                        className: isSticky ? `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buttonSecondary"]} !border-white` : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buttonPrimary"],
                                        children: "Sign up"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(marketing)/components/Header.tsx",
                                        lineNumber: 91,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "root-container lg:hidden flex items-center justify-between h-16",
                        children: [
    ...
    `,
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: `py-10 flex flex-col justify-between h-full ${isSticky ? "text-primary" : ""}`,
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                                    className: "flex flex-col gap-2 ",
                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navLinks"].map((link)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: link.href,
                                            className: `root-container flex items-center gap-2 capitalize py-3 font-medium ${pathname === link.href ? "bg-primary/5 border-r-4 border-primary" : ""}`,
                                            children: link.name
                                        }, link.name, false, {
                                            fileName: "[project]/src/app/(marketing)/components/Header.tsx",
                                            lineNumber: 168,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "root-container pb-10 space-y-4 w-full",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Header, "jXGHbkwQvzNB8tf4JGFLDYY0f+g=", false, function() {
    return [
...
//# sourceMappingURL=src_0f37df37._.js.map